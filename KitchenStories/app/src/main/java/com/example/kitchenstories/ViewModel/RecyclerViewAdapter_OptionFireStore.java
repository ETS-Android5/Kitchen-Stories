...
public class RecyclerViewAdapter_OptionFireStore extends FirestoreRecyclerAdapter<Recipe, RecyclerViewAdapter_OptionFireStore.MyViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull @NotNull MyViewHolder holder, int position, @NonNull @NotNull Recipe model) {
        ...
        holder.btn_likeAmount_itemRecipe.setText(model.getLikeAmount().toString());
    ...
    public void checkLikeExist(Boolean check, @NonNull @NotNull MyViewHolder holder){
        ...
        if (isCheckGlobal){
            ...
            holder.btn_likeAmount_itemRecipe.setSelected(true);
        }
        else {
            //Log.d("TESTAUTH", "FALSE!!!");

            holder.btn_likeAmount_itemRecipe.setSelected(false);
        }
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull @NotNull View itemView) {
            ...
            btn_likeAmount_itemRecipe.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
        ...
        public void checkLikeUserExist(Boolean check, String recipeID, String emailUserCurrent) {
            ...
            if (!isLikeUserExist) {
                ...
                btn_likeAmount_itemRecipe.setSelected(true);
                ...
                btn_likeAmount_itemRecipe.setSelected(false);
