...
public class RecyclerViewAdapter_LargeItem extends RecyclerView.Adapter<RecyclerViewAdapter_LargeItem.MyViewHolder> {

    Context mContext;
    ArrayList<Recipe> mData;

    public RecyclerViewAdapter_LargeItem(Context mContext, ArrayList<Recipe> mData) {
